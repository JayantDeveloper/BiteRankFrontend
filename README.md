...
This repository contains the **public-facing web interface** for BiteRank.  
It communicates with the backend to fetch and display ranked deals, letting users explore the top food values in real time.

**Related Repositories**
- [Backend (API + Data Scraper)](https://github.com/JayantDeveloper/BiteRankBackend)

Visit the live site → [biterank.tech](https://biterank.tech)
